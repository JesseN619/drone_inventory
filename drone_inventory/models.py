...
import uuid
# universal unique identifier - creates user ids
...
# import for marshmallo marshaller
...
class DroneSchema(ma.Schema):
    class Meta:
        ...
        fields = ['id', 'name','description', 'price', 'camera_quality', 
        'flight_time', 'max_speed', 'dimensions', 'weight', 'cost_of_prod', 'series']

    # take a python class object like <Drone x324324313343124>
    # iterates through fields and adds them to a dict
